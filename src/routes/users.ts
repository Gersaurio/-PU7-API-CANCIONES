...
users.route('/users').post( async(req:Request,res:Response)=>{
    try {
        const body = req.body;
...
users.route('/users/login').post( async(req:Request,res:Response)=>{
    try {
        const body = req.body;
...
users.route('/users/:id').get( async(req:Request,res:Response)=>{
    try {
